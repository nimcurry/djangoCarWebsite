...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if (has_contacted):
                messages.error(request, "you have already made and enquiry about this car.. Please wait until we get back to you")
        ...
        send_mail(
            'new car enquiry',
            'You have new enquiry for car'+ car_title + 'please check admin for more info',
            'nimcurry@gmail.com',
            [admin_email_id],
            fail_silently=False,
            )
